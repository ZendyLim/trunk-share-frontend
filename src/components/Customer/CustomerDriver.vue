  ...
  <div class="main">
    <div>
      <b-navbar fixed="top" type="dark" class="bg-pink">
        ...
        <b-navbar-nav class="m-auto">
          <b-nav-item>
            <h3 class="text-light">Choose a Driver</h3>
          </b-nav-item>
        </b-navbar-nav>
    ...
    <b-container>
      <b-row style="padding-top: 75px;">
        <b-col cols="12" class="text-left pt-2 pb-2">Please choose a driver.</b-col>
        <b-col cols="12" style="background: #fceae5; margin-bottom: 5px;" v-for="(driver, index) in drivers">
          <b-row>
            <b-col cols="3" class="text-center">
              <b-img rounded="circle" width="60" height="60" src="../../assets/img1.jpg" fluid alt="img"
                     class="m-1"/>
